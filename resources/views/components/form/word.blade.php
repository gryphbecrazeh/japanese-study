<form class="flex flex-col justify-evenly items-start gap-2" action="{{ route('admin.manager.word.update') }}"
    method="post">
    @csrf
    ...
    <div class="flex flex-col items-start justify-evenly gap-2 w-full">
        <label>Kanji</label>
        <div>
            <x-element.input name="id" id="id" class="hidden" value="{{ $word->id ?? '' }}" />
    ...
    <div>
        <x-element.input name="verbType" id="verbType" class="
        @error('verbType')
                                                                                                                                                                                                                                                                                                                                                                                        border-red-500
        @enderror
        " value="{{ $verbType }}" />
