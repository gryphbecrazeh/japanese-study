...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      // autokana' : 'standard
      document.addEventListener('DOMContentLoaded', function () {
        var autokana = document.getElementById('autokana'),
...
/***/ "./resources/js/controllers/meaning-controller.js":
/*!********************************************************!*\
  !*** ./resources/js/controllers/meaning-controller.js ***!
  \********************************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      document.addEventListener('DOMContentLoaded', function () {
        _this.element.innerHTML = _this.element.innerHTML.replace(/([一-龯])/gmi, '<span data-action="mouseover->meaning#showMeaning">$1</span>'); // Find all kanji characters in this.textcontent and replace them with spans that on hover display the meaning
      });
    }
  }, {
    key: "showMeaning",
    value: function showMeaning(e) {
      var _e$target$getAttribut;

      var kanji = e.target.innerText;
      var existingMeaning = (_e$target$getAttribut = e.target.getAttribute('meaning')) !== null && _e$target$getAttribut !== void 0 ? _e$target$getAttribut : null;

      if (!existingMeaning) {
        axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("https://kanjialive-api.p.rapidapi.com/api/public/kanji/".concat(kanji), {
          headers: {
          ...
          console.log(res);
          var meaning = res.data.kanji.meaning.english;
          e.target.setAttribute('meaning', meaning);
        })["catch"](function (err) {
          return console.log('oh fuck', err);
        });
      } else {
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      var collapseButton = this.element.querySelector('.collapse-button');
...
/***/ "./resources/js/controllers/report-controller.js":
/*!*******************************************************!*\
  !*** ./resources/js/controllers/report-controller.js ***!
  \*******************************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function handleReport(e) {
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(this.pathValue).then(function (res) {
...
__webpack_require__(/*! /home/pi/Web/japanese-study/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/pi/Web/japanese-study/resources/css/main.css */"./resources/css/main.css");
