...
application.load(Object(stimulus_webpack_helpers__WEBPACK_IMPORTED_MODULE_1__["definitionsFromContext"])(context)); // import resolveConfig from 'tailwindcss/resolveConfig'
// import tailwindConfig from '../../tailwind.config.js'
// window.tailwind = resolveConfig(tailwindConfig)
...
/***/ "./resources/js/controllers/Game.js":
/*!******************************************!*\
  !*** ./resources/js/controllers/Game.js ***!
  \******************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return GAME_OBJ; });
...
var GAME_OBJ = function GAME_OBJ(STATICDICTIONARY) {
  var _this = this;
  ...
  this.resetScore = function () {
    return _this.score = 0;
  };

  this.kanjiAlive = function () {
    // Comment this out?
    var getKanjiMeaning = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(kanji) {
        var apiQuery, result;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                apiQuery = "https://kanjialive-api.p.rapidapi.com/api/public/search/".concat(kanji);
                result = fetch('http://example.com/movies.json').then(function (response) {
      ...
      return function getKanjiMeaning(_x) {
  ...
  this.resetTargetVerb = function () {
    return _this.targetVerb = new Verb({
      meaning: "",
      politeForm: "",
      rePoliteForm: ""
    });
  ...
  this.getKnownWords = function () {
    return _toConsumableArray(_this.getLearnedWords().filter(function (word) {
      return word.shouldKnow;
    }));
  };

  this.getStrugglingWords = function () {
    return _toConsumableArray(_this.getLearnedWords().filter(function (word) {
      return !word.timesRight > word.timesWrong;
    }));
  };
  ...
  this.getProbableDicitonary = function () {
    ...
    for (var i = 0; i < probability; i++) {
      resultDictionary.push.apply(resultDictionary, _toConsumableArray(dictionary));
    }
  ...
  this.getRandomWord = function (callback) {
    ...
    var probableDictionary = [].concat(_toConsumableArray(_this.getProbableDicitonary(learnedWords, probabilities.learned)), _toConsumableArray(_this.getProbableDicitonary(knownWords, probabilities.known)), _toConsumableArray(_this.getProbableDicitonary(strugglingWords, probabilities.struggling))); // Filter out previous word from probable dicitonary

    if (learnedWords.length > 1 && _this.previousWord) {
      probableDictionary = probableDictionary.filter(function (word) {
        return word.kanji.word != _this.previousWord.kanji.word;
      });
    }

    var randWord = probableDictionary[_this.getRandomIndex(probableDictionary)];

    if (randWord != null) return randWord;
  };

  this.getTargetVerb = function () {
    return _this.targetVerb;
  };

  this.setTargetVerb = function (newVerb) {
    return _this.targetVerb = new Verb(newVerb);
  };

  this.newTargetVerb = function () {
    return _this.setTargetVerb(_this.getRandomWord());
  };
  ...
  this.setUserInput = function (input) {
    return _this.userInput = input;
  };

  this.clearUserInput = function () {
    return _this.userInput = null;
  };

  this.getHiraganaInput = function () {
    return _this.userHiragana;
  };

  this.setHiraganaInput = function () {
    _this.userHiragana = _this.userInput;

    _this.clearUserInput();
  };

  this.clearHiraganaInput = function () {
    return _this.userHiragana = null;
  };

  this.getMeaningInput = function () {
    return _this.userMeaning;
  };

  this.setMeaningInput = function () {
    _this.userMeaning = _this.userInput;

    _this.clearUserInput();
  };

  this.clearMeaningInput = function () {
    return _this.userMeaning = null;
  };

  this.clearInputs = function () {
    _this.clearUserInput();

    _this.clearHiraganaInput();
...
/***/ "./resources/js/controllers/Verb.js":
/*!******************************************!*\
  !*** ./resources/js/controllers/Verb.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Verb; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var Verb = function Verb(_ref) {
  var _this = this;

  var _ref$meaning = _ref.meaning,
      meaning = _ref$meaning === void 0 ? "" : _ref$meaning,
      _ref$meanings = _ref.meanings,
      meanings = _ref$meanings === void 0 ? [] : _ref$meanings,
      _ref$rePoliteForm = _ref.rePoliteForm,
      rePoliteForm = _ref$rePoliteForm === void 0 ? "" : _ref$rePoliteForm,
      _ref$politeForm = _ref.politeForm,
      politeForm = _ref$politeForm === void 0 ? "" : _ref$politeForm,
      _ref$kanji = _ref.kanji,
      kanji = _ref$kanji === void 0 ? {
    word: "",
    meaning: ""
  } : _ref$kanji,
      hasLearned = _ref.hasLearned,
      shouldKnow = _ref.shouldKnow,
      timesWrong = _ref.timesWrong,
      timesRight = _ref.timesRight;

  _classCallCheck(this, Verb);

  this.increaseTimesCorrect = function (callback) {
    _this.timesRight++;
    if (!_this.hasLearned) _this.toggleLearned();

    if (_this.timesRight > 0 + _this.timesWrong + _this.timesWrongOffset && !_this.shouldKnow) {
      _this.toggleKnown();
    }
  ...
  this.increaseTimesWrong = function (callback) {
    _this.timesWrong++;
    if (_this.shouldKnow) _this.toggleKnown();
    if (callback) return callback(_this);
  };

  this.toggleKnown = function () {
    return _this.shouldKnow = !_this.shouldKnow;
  };

  this.toggleLearned = function () {
    return _this.hasLearned = !_this.hasLearned;
  };

  this.timesWrongOffset = 3; //     change to array of meanings, allow for comma separated entries for multiple meanings and multiple points
    ...
    value: function render() {
      ...
      ************************************************************/
      jQuery.fn.autokana = function () {
        // kana mapping
        var kana = [["tsu", "つ"], ["TSU", "ツ"], ["dji", "ぢ"], ["dzu", "づ"], ["DJI", "ヂ"], ["DZU", "ヅ"], ["kya", "きゃ"], ["kyu", "きゅ"], ["kyo", "きょ"], ["sha", "しゃ"], ["shu", "しゅ"], ["sho", "しょ"], ["cha", "ちゃ"], ["chu", "ちゅ"], ["cho", "ちょ"], ["nya", "にゃ"], ["nyu", "にゅ"], ["nyo", "にょ"], ["hya", "ひゃ"], ["hyu", "ひゅ"], ["hyo", "ひょ"], ["mya", "みゃ"], ["myu", "みゅ"], ["myo", "みょ"], ["rya", "りゃ"], ["ryu", "りゅ"], ["ryo", "りょ"], ["gya", "ぎゃ"], ["gyu", "ぎゅ"], ["gyo", "ぎょ"], ["jya", "じゃ"], ["jyu", "じゅ"], ["jyo", "じょ"], ["dya", "ぢゃ"], ["dyu", "ぢゅ"], ["dyo", "ぢょ"], ["bya", "びゃ"], ["byu", "びゅ"], ["byo", "びょ"], ["pya", "ぴゃ"], ["pyu", "ぴゅ"], ["pyo", "ぴょ"], ["KYA", "キャ"], ["KYU", "キュ"], ["KYO", "キョ"], ["SHA", "シャ"], ["SHU", "シュ"], ["SHO", "ショ"], ["CHA", "チャ"], ["CHU", "チュ"], ["CHO", "チョ"], ["NYA", "ニャ"], ["NYU", "ニュ"], ["NYO", "ニョ"], ["HYA", "ヒャ"], ["HYU", "ヒュ"], ["HYO", "ヒョ"], ["MYA", "ミャ"], ["MYU", "ミュ"], ["MYO", "ミョ"], ["RYA", "リャ"], ["RYU", "リュ"], ["RYO", "リョ"], ["GYA", "ギャ"], ["GYU", "ギュ"], ["GYO", "ギョ"], ["JYA", "ジャ"], ["JYU", "ジュ"], ["JYO", "ジョ"], ["DYA", "ヂャ"], ["DYU", "ヂュ"], ["DYO", "ヂョ"], ["BYA", "ビャ"], ["BYU", "ビュ"], ["BYO", "ビョ"], ["PYA", "ピャ"], ["
        this.keyup(function () {
          var input_field_string = this.value;
          var speed_offset_error = 0; // iterate through kana mapping and modify the input string if possible

          for (var i = 0; i < kana.length; i++) {
            input_field_string = input_field_string.replace(kana[i][0], kana[i][1]);
            if (input_field_string != this.value) break;
          } // set the correct cursor location


          if (input_field_string != this.value) {
            var original_string = this.value.split(""); // replace roumaji with kana in the textfield

            this.value = input_field_string;
            var new_string = input_field_string.split("");
            var tmp_new_length = new_string.length; // too fast typing cursor position error fix

            for (var i = 0; i < new_string.length; i++) {
              var char_value = new_string[i].charCodeAt(0);
              if (char_value >= 65 && char_value <= 90 || char_value >= 97 && char_value <= 122) speed_offset_error = 1;
...
/***/ "./resources/js/controllers/flexible-controller.js":
/*!*********************************************************!*\
  !*** ./resources/js/controllers/flexible-controller.js ***!
  \*********************************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      var separator = 'ENDOFLINE';
      var targetSelector = '.flexible-input-container';

      var handleFlexibleInputs = function handleFlexibleInputs() {
        var targetSelector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.flexible-input-container';
        var separatorString = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'ENDOFLINE';

        var flexibleInputContainers = _toConsumableArray(document.querySelectorAll(targetSelector));

        flexibleInputContainers.forEach(function (target) {
          // const addButton = target.querySelector(".add-new:last-of-type")
          var consolidatedInput = target.querySelector(".consolidated-input"); // -- funcitons --

          var getInputsFromTextArea = function getInputsFromTextArea() {
            var effectInputs = _toConsumableArray(consolidatedInput.value.split(separatorString));

            return effectInputs;
          };

          var clearInputs = function clearInputs() {
            var oldInputs = _toConsumableArray(target.querySelectorAll(".card-input"));
          ...
          var createEffectInput = function createEffectInput(effect) {
            var newCardInput = document.createElement('div');
            newCardInput.classList.add('card-input');
            var newInput = document.createElement('input');
            newInput.classList.add("flexible-input");
            newInput.placeholder = "Input..."; //  newInput.value = ''
          ...
          var renderInputs = function renderInputs() {
            clearInputs();
            var effectsValues = getInputsFromTextArea();
            effectsValues.forEach(function (effect) {
          ...
          var updateMaster = function updateMaster() {
            ...
            var inputs = _toConsumableArray(target.querySelectorAll(".flexible-input"));

            clearInputs();

            var updatedEffects = _toConsumableArray(inputs.map(function (input) {
              return input.value;
          ...
          var addInputButton = function addInputButton() {
            var tmp = consolidatedInput.value + separatorString;
          ...
          var deleteInput = function deleteInput(e) {
...
/***/ "./resources/js/controllers/game-controller.js":
/*!*****************************************************!*\
  !*** ./resources/js/controllers/game-controller.js ***!
  \*****************************************************/
/*! exports provided: default */
...
var GAME_OBJ = __webpack_require__(/*! ./Game */ "./resources/js/controllers/Game.js")["default"];
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "render",
    value: function render() {
      var STATICDICTIONARY = JSON.parse(this.data.get('vocabulary')); // Idea, make user type in the name of the word before entering it's meaning
      ...
      var backupInput = input.cloneNode(true); // Used for refreshing the input

      var secondaryInput = document.querySelector("#secondary-input");
      ...
      */
      ...
      var handleSubmitButton = function handleSubmitButton() {
        ...
        var targetVerb = GAME.getTargetVerb();
        ...
        if (GAME.getHiraganaInput() && !GAME.getMeaningInput()) {
          if (handleCheckAnswers(targetVerb, userInput) > 0) {
            GAME.success(function () {
              // 
              postAlert("Correct!, ".concat(targetVerb.politeForm, " means to ").concat(targetVerb.meanings.join(", ")), "correct");
            });
          } else {
            GAME.fail(function () {
              // 
              postAlert("Incorrect\n".concat(targetVerb.politeForm, "\nmeans to\n").concat(targetVerb.meanings.join(", ")), "incorrect");
            });
          }
      ...
      var handleCopyButton = function handleCopyButton() {
        var dictionaryDomObject = document.createElement("input");
        dictionaryDomObject.value = JSON.stringify(_toConsumableArray(dictionary));
      ...
      var handleReset = function handleReset() {
        ...
        answerDictionary = _toConsumableArray(STATICDICTIONARY);
        levels = _toConsumableArray(handleGetChunks(STATICDICTIONARY));
        levelActive = 0;
        dictionary = levels[levelActive];
        setLocalStorage();
        var randomWord = getRandomWord(function (word) {
          postAlert("New Word!, ".concat(word.politeForm, " means to ").concat(word.meanings.join(", ")));
        }) || "no random word";
        targetVerb = _objectSpread(_objectSpread({}, targetVerb), randomWord);
      ...
      var handleStudyLoop = function handleStudyLoop() {
        input.focus();
        ...
        var displayText,
            targetVerb = GAME.getTargetVerb() || null;
        ...
        if (!GAME.getHiraganaInput()) {
          input.placeholder = "Enter the romanji to automatically convert it to hiragana...";
          displayText = "\n            <p>Please enter</p>\n        <p class=\"kanji\">\n    ".concat(targetVerb.kanji.word, "\n    </p>\n    <p>\n            ").concat(targetVerb.shouldKnow ? "You should know this..." : targetVerb.politeForm, "\n    </p>\n            ");
          setDisplay(displayText);
          $(input).autokana();
        } else {
          input.placeholder = "Enter the meanings, separated by a comma...";
          displayText = "\n            <p>Translate Below</p>\n        <p class=\"kanji\">\n    ".concat(targetVerb.kanji.word, "</p>\n    <p>\n").concat(targetVerb.shouldKnow ? "You should know this..." : targetVerb.politeForm, "\n    </p>\n            ");
          setDisplay(displayText);
        } // 
        // 
        // render statistics
        ...
        var newInfo = "Level: ".concat(GAME.levelActive + 1, "/").concat(GAME.levels.length, ", Score: ").concat(GAME.getScore(), ", Word Count:").concat(GAME.getLearnedWords().length); // , Mode: ${ modeActive }
        //   , Input Target: ${targetModeActive}

        info.innerText = newInfo;
      };

      var postAlert = function postAlert(alertString, type) {
        ...
        setTimeout(function () {
          return notificationContainer.removeChild(alert);
        }, 3000);
      };

      var renewInput = function renewInput() {
      ...
      var handleForgetButton = function handleForgetButton() {
        var targetWord = dictionary.find(function (word) {
          return word.politeForm === targetVerb.politeForm;
        });
        targetWord.increaseTimesWrong(); // postAlert("You forgot", "incorrect")
      };

      var handleCheckAnswers = function handleCheckAnswers(targetVerb, answer) {
        var results = 0; //PROBLEM this might be stripping out spaces during the answers that contain spaces

        var r = /\s*\,\s*/gim;

        var answers = _toConsumableArray(answer.split(r));

        answers.forEach(function (separatedAnswer) {
          if (targetVerb.meanings.find(function (meaning) {
            return separatedAnswer.match(meaning);
          })) results++;
        });
        return results;
      }; // Core loop funciton
      ...
      var loopMain = function loopMain() {
        handleStudyLoop();
      }; // Initiate the loop


      $(document).ready(function () {
        loopMain(); // attach auto-kana plugin with default options
      });
...
__webpack_require__(/*! /data/code/php/japanese-study/japanese-study/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /data/code/php/japanese-study/japanese-study/resources/css/main.css */"./resources/css/main.css");
